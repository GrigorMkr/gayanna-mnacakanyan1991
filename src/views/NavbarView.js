        ...
        logo.innerHTML = `
            <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="rotatingBorder">
                    ...
                    <circle cx="50" cy="50" r="47" stroke="url(#rainbowGradient)" stroke-width="2.5" fill="none" filter="url(#neonGlowStrong)" opacity="0.3"/>
                </g>
                ...
                <g id="rotatingColors">
                    <animateTransform attributeName="transform" type="rotate" values="0 50 50;360 50 50" dur="15s" repeatCount="indefinite"/>
                    <ellipse cx="50" cy="18" rx="9" ry="4" fill="#FF0080" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="75" cy="35" rx="9" ry="4" fill="#FFD700" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="82" cy="50" rx="9" ry="4" fill="#00FF80" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="75" cy="65" rx="9" ry="4" fill="#0080FF" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="50" cy="82" rx="9" ry="4" fill="#FF00FF" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="25" cy="65" rx="9" ry="4" fill="#FF4000" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="18" cy="50" rx="9" ry="4" fill="#00FFFF" filter="url(#neonGlow)" opacity="1"/>
                    <ellipse cx="25" cy="35" rx="9" ry="4" fill="#8000FF" filter="url(#neonGlow)" opacity="1"/>
                </g>
                ...
                <path d="M65 35 L73 25 L74 30 L66 40 Z" fill="url(#logoGradient)" opacity="0.95"/>
                <path d="M65 35 L73 25" stroke="url(#logoGradient)" stroke-width="3.5" stroke-linecap="round"/>
                <path d="M66 40 L74 30" stroke="url(#logoGradient)" stroke-width="3.5" stroke-linecap="round"/>
                <path d="M69 24 L70 19" stroke="url(#logoGradient)" stroke-width="3" stroke-linecap="round"/>
            </svg>
        `;
